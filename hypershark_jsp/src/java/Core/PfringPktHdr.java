...
public class PfringPktHdr
{
    ...
    public String getPacket(String appProto)
    {
        ...
        pfring_pkt_str="<table width=100%><tr width=100% align=\"center\"><td width=20%>"+BuildString.mac_string(smac)+"</td><td width=20%>"+BuildString.mac_string(dmac)+"</td><td width=22%>"+((ip_src>>24) & 0xFF) + "." + ((ip_src>> 16) & 0xFF) + "." + ((ip_src>> 8) & 0xFF) +"."+ ((ip_src) & 0xFF)+"</td><td width=22%>"+
