...
public class Iphdr extends L3proto
{
    ...
    @Override
     public String getPacket()
     {
        ...
        ip_pkt_str="<b>IP HEADER</b>"+"<br>"+"<b>ihl&nbsp;&nbsp;::&nbsp;&nbsp;</b>"+ihl+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"<b>version&nbsp;&nbsp;::&nbsp;&nbsp;</b>"+version+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"<b>tos&nbsp;&nbsp;::&nbsp;&nbsp;</b>"+tos+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"<b>tot_len&nbsp;&nbsp;::&nbsp;&nbsp;</b>"+Conversions.shortToUnsigned(tot_len)+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"<b>id&nbsp;&nbsp;::&nbsp;&nbsp;</b>"+Conversions.shortToUnsigned(id)+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"<b>frag_off&nbsp;&nbsp;::&nbsp;&nbsp;</b>"+frag_off+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"<b>ttl&nbsp;&nbsp;::&nbsp;&nbsp;</b>"+ttl+"<b>protocol&nbsp;&nbsp;::&nbsp;&nbsp;</b>"+protocol+"</br>"+"&nbsp;&nbsp;"+"<b>check&nbsp;&nbsp;::&nbsp;&nbsp;</b>"+Conversions.shortToUnsigned(check)+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"<b>saddr&nbsp;&nbsp;::&nbsp;&nbsp;</b>"+(saddr & 0xFF) + "." + ((saddr>> 8) & 0xFF) + "." + ((saddr>> 16) & 0xFF) +"."+ ((saddr>> 24) & 0xFF)+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+"<b>daddr&nbsp;&nbsp;::&nbsp;&nbsp;</b>"+(daddr & 0xFF) + "." + ((daddr>> 8) & 0xFF) + "." + ((daddr>> 16) & 0xFF) +"."+ ((daddr>> 24) & 0xFF)+"<br/>"+"<br/>";
        return(ip_pkt_str);
     }
}
